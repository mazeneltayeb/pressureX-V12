                ...
                <Table hover>
                  <thead className="table-light">
                    <tr>
                      ...
                      <th>السعر</th>
                      <th>الكمية</th>
                      <th className="d-none d-sm-none d-md-table-cell">المخزون</th>
                      <th>المجموع</th>
                      <th>إجراءات</th>
                    </tr>
                  </thead>
...
<Col lg={8}>
  <Card className="shadow-sm mb-4">
    ...
    <Card.Body className="p-0 p-sm-3">
      تصميم للشاشات الكبيرة (يظهر من MD فأعلى)
          ...
          <Table hover className="mb-0">
            <thead className="table-light">
              <tr>
                ...
                <th>المنتج</th>
                <th style={{ minWidth: '90px' }}>السعر</th>
                <th style={{ minWidth: '140px' }}>الكمية</th>
                <th>المخزون</th>
                <th style={{ minWidth: '100px' }}>المجموع</th>
      ...
      {/* تصميم للشاشات الصغيرة (يظهر للأقل من MD) */}
      <div className="d-md-none">
        {cartItems.length === 0 ? (
          <div className="text-center py-5">
            <p className="text-muted">لا توجد منتجات في السلة</p>
          </div>
        ) : (
          <div className="cart-items-mobile">
            {cartItems.map((item) => (
              <div key={item.id} className="cart-item-mobile border-bottom p-3">
                ...
                <div className="d-flex mb-3 justify-content-between" >
                  ...
                  <div className="text-center" style={{ width: '50%' }}>
                    ...
                    <div className="mb-2">
                      ...
                      {/* التفاصيل في صفوف */}
                <div className="row g-2 mb-2 " style={{ width: '50%' }} >
                  <div className="col-6" style={{ width: '100%' }}>
                    <div className="d-flex align-items-center bg-light p-2 rounded justify-content-center">
                      <span className="me-2 fw-bold text-primary">السعر:</span>
                      <span className="fw-bold">{item.price} ج.م</span>
                    </div>
                  </div>
                  <div className="col-6" style={{ width: '100%' }}>
                    <div className="d-flex align-items-center bg-light p-2 rounded justify-content-center">
                      <span className="me-2 fw-bold text-success">المجموع:</span>
                      <span className="fw-bold text-success">{item.price * item.quantity} ج.م</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="row align-items-center g-3">
                  <div className="col-7">
                    <div className="d-flex align-items-center">
                      <span className="me-2 fw-bold">الكمية:</span>
                  ...
                  <div className="col-5">
                    <div className="d-flex align-items-center justify-content-between">
                      <div>
                        {item.stock !== undefined ? (
                          item.quantity > item.stock ? (
                            <Badge bg="danger" className="p-2">غير كافي</Badge>
                          ) : item.stock < 10 ? (
                            <Badge bg="warning" className="p-2">أقل من {item.stock}</Badge>
                          ) : (
                            <Badge bg="success" className="p-2">متوفر</Badge>
                          )
                        ) : (
                          <Badge bg="secondary" className="p-2">غير محدد</Badge>
                        )}
                      </div>
                    </div>
                  </div>
